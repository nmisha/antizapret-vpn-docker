...
case "$*" in
*az-local.antizapret*) echo new-local;;
*az-world.antizapret*) [ "${WORLD_DOWN:-0}" != 1 ] || exit 28; echo new-world;;
...
*) exit 99;;
    ...
    def test_missing_world_does_not_fail_healthcheck_or_refresh_filters(self):
    ...
    def test_filter_failure_keeps_dns_healthy_and_retries_after_recovery(self):
        ...
        self.assertEqual((self.root / '.config_md5').read_text(), 'new-local new-world\n')
